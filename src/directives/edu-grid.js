								...
								if ($scope.options.formAvancedSearchResult.hasOwnProperty(v.key))
								{
									...
									if (v.hasOwnProperty('betweenFields')){
											...
											if(v.betweenFields.hasOwnProperty('fieldRight') && v.betweenFields.hasOwnProperty('fieldLeft')){
												...
												filterAS.push(
																"["+optionsBF.fieldLeft +"]"+ optionsBF.operatorLeft + $scope.options.formAvancedSearchResult[v.key] + 
																" AND ([" + optionsBF.fieldRight +"]"+ optionsBF.operatorRight + $scope.options.formAvancedSearchResult[v.key] +" OR ["+ optionsBF.fieldRight +"] IS NULL)"	
												)	
