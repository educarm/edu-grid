        ...
        $timeout(function () {
          ...
          angular.element(document).mousemove(function (e) {
            if (pressed) {
              ...
              console.log('id' + id + ' avance:' + advance + ' current a22:' + porcCurrent + '% next newPorc:' + porcentaje);  //angular.element('#' + $scope.options.metaData.id+'  TABLE.dragtarget#'+nextId).parents('.box').width(widthNextElement-(e.pageX-startX));
