  ...
  return {
    ...
    controller: [
      ...
      function ($scope, $log, dataFactoryGrid, $timeout, $document) {
        ...
        $scope.internalControl.showButtonRow = function (indexRow, show) {
          if ($scope.list && indexRow >= 0 && $scope.list.length > 0 && indexRow < $scope.list.length) {
            $scope.list[indexRow].showButton = show;
          }
        };
        // ---
